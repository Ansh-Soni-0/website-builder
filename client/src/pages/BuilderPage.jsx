...
const BuilderPage = () => {
  ...
  const {activeProject , loadingActiveProject , activeFile , setActiveFile , showCode , setShowCode , loadProject , logout , chatLoading , handleChat} = useAppContext();
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      setPublishUrl(url)
      toast.success("Website publishied successfully!")
    } catch (err) {
