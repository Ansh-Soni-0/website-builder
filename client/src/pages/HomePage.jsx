    ...
    <div className="h-screen overflow-y-scroll text-white font-sans bg-[url('/bg-img.png')] bg-cover bg-center bg-no-repeat">
      ...
      <nav className='sticky top-0 z-10 flex items-center justify-between px-6 py-4'>
        <div className='flex items-center gap-2'>
          ...
          <span className='text-xl font-semibold tracking-tight'>Buildify</span>
        </div>
      ...
      <div className='flex-1 flex flex-col items-center justify-center px-6 pb-20 mt-8'>
        ...
        <div className='w-full max-w-2xl flex flex-col items-center'>
          ...
          <div className='flex items-center gap-2 p-1.5 pr-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-[13px] text-white/90'>
            <span className='px-3 py-1 text-[11px] bg-red-700 rounded-full font-medium'>PROMO</span>
            <span>Create you first project for free</span>
          </div>
                    ...
                    <div key={p._id} className='bg-white/5 border border-white/10 rounded-lg px-4 py-3 flex items-center justify-between group hover:border-white/20 hover:bg-white/10 cursor-pointer backdrop-blur-md transition-all' onClick={() => navigate(`/builder/${p._id}`)}>
                      <div className='flex-1 min-w-0'>
                        ...
                        <div className='flex items-center gap-3 mt-0.5'>
                          <span className='flex text-xs text-zinc-300 items-center gap-1'>
                            <ClockIcon size={10}/>
                      ...
                      <div className='flex items-center gap-2'>
                        ...
                        >
                          <Trash2Icon size={30} className='p-1.5 rounded-md text-zinc-200 hover:text-red-400 hover:bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity'/>
                        </butto>
